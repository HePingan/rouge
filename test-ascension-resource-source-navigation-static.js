...
assert(/showAscensionUI\s*=\s*false/.test(main), 'ascension source route should close ascension panel');
assert(/showStageSelectUI\s*=\s*true/.test(main), 'ascension source route should open stage panel');
