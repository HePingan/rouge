...
assert(smokeHtml.includes('index.html?smoke=bottom-canvas-safe-area&v=20260606safearea6'), 'browser smoke iframe should load the current cachebuster token explicitly');
