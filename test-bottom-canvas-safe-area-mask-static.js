...
assert(main.includes("g.addColorStop(0.14, 'rgba(53,99,146,0.94)')"), 'canvas bottom mask should use a clearly visible blue gradient');
...
assert(smokeHtml.includes('index.html?smoke=bottom-canvas-safe-area&v=20260607safearea7'), 'browser smoke iframe should load the current cachebuster token explicitly');
...
assert(smokeHtml.includes('darkPct === 0') && smokeHtml.includes('avg[1] >= 95') && smokeHtml.includes('avg[2] >= 145'), 'browser smoke should fail if the bottom strip is black or too visually dark');
