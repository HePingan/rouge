...
assert(smokeHtml.includes('index.html?v=20260606safearea6&smoke=bottom-canvas-safe-area'), 'browser smoke iframe should load the current cachebuster token explicitly');
