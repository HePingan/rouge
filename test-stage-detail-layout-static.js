...
assert(css.includes('Mobile Stage Detail Sheet Safe Area 20260607safearea8'), 'detail sheet safe-area marker missing');
...
assert(index.includes('20260607safearea8'), 'index cachebuster should include detailfix token');
