...
assert(css.includes('Mobile Stage Detail Sheet Safe Area 20260605combatp3'), 'detail sheet safe-area marker missing');
...
assert(index.includes('20260605combatp3'), 'index cachebuster should include detailfix token');
