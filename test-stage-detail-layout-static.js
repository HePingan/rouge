...
assert(css.includes('Mobile Stage Detail Sheet Safe Area 20260606safearea5'), 'detail sheet safe-area marker missing');
...
assert(index.includes('20260606safearea5'), 'index cachebuster should include detailfix token');
