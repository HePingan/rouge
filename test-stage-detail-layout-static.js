...
assert(css.includes('Mobile Stage Detail Sheet Safe Area 20260607safearea11'), 'detail sheet safe-area marker missing');
...
assert(index.includes('20260607safearea11'), 'index cachebuster should include detailfix token');
