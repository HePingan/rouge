...
assert(/js\/tribulation\.js\?v=20260605combatp3/.test(html), 'tribulation.js should load before main with current cachebuster');
assert(html.includes('css/style.css?v=20260605combatp3'), 'style cachebuster should be bumped');
assert(html.includes('js/main.js?v=20260605combatp3'), 'main cachebuster should be bumped');
