...
assert(index.includes('20260605combatp3'), 'cachebuster should bump to endgame6 for immortal continuation chapters');
assert(!index.includes('20260524endgame5'), 'index should not keep stale endgame5 token');
mustInclude(css, 'Mobile Universal Interface Layout 20260605combatp3', 'mobile layout marker should bump');
