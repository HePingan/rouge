...
assert(css.includes('Combat Mobile Bottom Sheet 20260530ascguard1'), 'mobile combat layout marker should be bumped for combat HUD optimization');
...
assert(html.includes('v=20260530ascguard1'), 'index cachebuster should update for combat HUD optimization');
