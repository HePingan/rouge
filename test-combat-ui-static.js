...
assert(html.includes('v=20260606safearea3'), 'index cachebuster should update for combat HUD optimization');
...
for (const file of mustBust) {
  const re = new RegExp(`${file.replace(/[.*+?^${}()|[\]\\]/g, '\\$&')}\\?v=20260606safearea3`);
