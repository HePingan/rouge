...
assert(css.includes('Combat Mobile Bottom Sheet 20260530synergy7'), 'mobile combat layout marker should be bumped for combat HUD optimization');
...
assert(html.includes('v=20260530synergy7'), 'index cachebuster should update for combat HUD optimization');
...
for (const file of mustBust) {
  const re = new RegExp(`${file.replace(/[.*+?^${}()|[\]\\]/g, '\\$&')}\\?v=20260530synergy7`);
