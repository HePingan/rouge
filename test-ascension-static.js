...
assert(index.includes('js/ascension.js?v=20260607safearea12'), 'index should load ascension.js with current cachebuster');
assert(index.includes('btn-ascension'), 'mobile more menu should expose 飞升/仙界 entry');
assert(index.includes('20260607safearea12'), 'cachebuster should use ascension version');
